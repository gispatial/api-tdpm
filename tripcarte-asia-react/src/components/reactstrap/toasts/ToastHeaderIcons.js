            ...
            <TabContent activeTab={this.state.activeTab}>
              <TabPane tabId="1">
                <Row>
                  <Col md="6" sm="12">
                    <Toast>
                      <ToastHeader icon="primary">Tripcarte.Asia</ToastHeader>
                      <ToastBody>
                  ...
                  <Col md="6" sm="12">
                    <Toast>
                      <ToastHeader icon="success">Tripcarte.Asia</ToastHeader>
                      <ToastBody>
                  ...
                  <Col md="6" sm="12">
                    <Toast>
                      <ToastHeader icon="info">Tripcarte.Asia</ToastHeader>
                      <ToastBody>
                  ...
                  <Col md="6" sm="12">
                    <Toast>
                      <ToastHeader icon="danger">Tripcarte.Asia</ToastHeader>
                      <ToastBody>
                  ...
                  <Col md="6" sm="12">
                    <Toast>
                      <ToastHeader icon="warning">Tripcarte.Asia</ToastHeader>
                      <ToastBody>
                  ...
                  <Col md="6" sm="12">
                    <Toast>
                      <ToastHeader icon="dark">Tripcarte.Asia</ToastHeader>
                      <ToastBody>
